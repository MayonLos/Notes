...
### AI / 工具链 `#ai`
- [[AgentSkills]] — AI Agent 行为标准，目录+Markdown 定义技能，渐进式加载
- [[渐进式加载]] — 信息分层按需加载的设计模式，Agent Skills 的核心机制
- [[API兼容性策略]] — LLM 服务商通过实现竞争对手 API 格式降低迁移成本的策略
- [[PyTorch]] — Meta 开源深度学习框架，动态计算图，学术界主流
...
- [[算子]] — 函数→函数的映射，把运算本身视为数学对象
- [[Laplace变换]] — 将微积分算子转化为复频域代数运算
