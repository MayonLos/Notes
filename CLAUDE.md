...
│   │   ├── cpp\                # C++ 编程语言概念（基础语法/OOP/STL/内存管理）
│   │   ├── math\               # 数学工具（Laplace变换、算子等）
│   │   ├── control\            # 控制理论（物理建模、方框图等）
│   │   ├── programming\        # AI 工具与编程范式（AgentSkills、PyTorch 等）
│   │   ├── embedded\           # 嵌入式开发（STM32、ROS，待填充）
│   │   └── digital\            # 数字电路与系统
...
| 子目录 | 存放内容 |
|:---|:---|
| `wiki\concepts\cpp\` | C++ 编程语言（基础语法、OOP、STL、内存管理） |
| `wiki\concepts\math\` | 数学工具（Laplace变换、算子等） |
| `wiki\concepts\control\` | 控制理论（物理建模、方框图、PID 等） |
| `wiki\concepts\programming\` | AI 工具与编程范式（AgentSkills、PyTorch、API策略等） |
| `wiki\concepts\embedded\` | STM32、ROS、嵌入式开发概念（待填充） |
...
## 概念
### C++ 编程
- [[concepts/cpp/xxx]] — 一句话定义

### 数学工具
- [[concepts/math/xxx]] — 一句话定义

### 控制理论
- [[concepts/control/xxx]] — 一句话定义
