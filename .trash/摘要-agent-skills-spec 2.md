...
> [!important] 一句话摘要
> Agent Skills 是 Anthropic 发布的开放标准，用目录 + Markdown 文件定义可渐进式加载的 AI Agent 行为指南，2025 年 12 月 18 日发布，与 MCP 并列构成 Agent 工具生态的两大支柱。
...
- [[AgentSkills]] — Agent Skills 技术概念详解
- [[渐进式加载]] — 渐进式加载设计模式
- [[agentskills-io]] — Agent Skills 开放标准实体
